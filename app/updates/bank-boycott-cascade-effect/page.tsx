...
export default function BankBoycottArticle() {
  ...
  return (
    ...
    >
      ...
      <p>A bank boycott is not chaos but <strong>precision</strong>. Coordinated via #99ResetCA, participants switch deposits to ethical alternatives like <strong>Vancity</strong> or <strong>Desjardins</strong>, which grew assets 3.26% in Q1 2025 (FSRA data).</p>
